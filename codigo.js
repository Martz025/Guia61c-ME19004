/* 
Guia: 61c
Nombre: Marvin Josue Martinez Escobar
Carnet: ME19004
Correo: me19004@ues.edu.sv
*/
...
var fila="<tr><td class='id'></td><td class='foto'></td><td class='price'></td><td class='title'></td><td class='description'></td><td class='category'></td></tr>";
  ...
  function codigoCat(catstr) {
	...
	function obtenerProductos() {
		fetch('https://retoolapi.dev/RtPwrt/productos')
			  .then(res=>res.json())
			  .then(data=>{
				  productos=data;
				  productos.forEach(
  ...
  function agregarproductos(){
	var producto={title:document.getElementById("titulo").value,
